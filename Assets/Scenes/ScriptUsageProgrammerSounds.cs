...
public class ScriptUsageProgrammerSounds : MonoBehaviour
{
    ...
    void PlayDialogue()
    {
        FMOD.Studio.EventInstance dialogueInstance = FMODUnity.RuntimeManager.CreateInstance(
            programmerSound.Guid
        );
    ...
    )
    {
        ...
        switch (type)
        {
            case FMOD.Studio.EVENT_CALLBACK_TYPE.CREATE_PROGRAMMER_SOUND:
            {
                ...
                var keyResult = FMODUnity.RuntimeManager.StudioSystem.getSoundInfo(
                    key,

...
namespace FMODHelpers
{
    ...
    {
        public static readonly FMOD.Studio.EVENT_CALLBACK Instance = new FMOD.Studio.EVENT_CALLBACK(
            FMODUnmanagedCallback
        );

        [AOT.MonoPInvokeCallback(typeof(FMOD.Studio.EVENT_CALLBACK))]
        static FMOD.RESULT FMODUnmanagedCallback(
            ...
            else if (userDataPtr != IntPtr.Zero)
            {
                ...
                switch (type)
                {
                    case FMOD.Studio.EVENT_CALLBACK_TYPE.CREATE_PROGRAMMER_SOUND:
                        ...
                        programmerSoundProperties.subsoundIndex = userData
                            .FmodSoundInfo
                            .subsoundindex;
                    ...
                    case FMOD.Studio.EVENT_CALLBACK_TYPE.TIMELINE_MARKER:
                        ...
                        HandleCallback(callback, userData.CallbackCancellationToken);
                        break;
        ...
        static async void HandleCallback(FMODCallback callback, CancellationToken cancellationToken)
        {
